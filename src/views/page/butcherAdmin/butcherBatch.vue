          ...
          <div class="padding">
            <van-form @submit="onSubmit">
              <van-field
                      v-model="batch"
                      name="batch"
                      label="屠宰批次编号" :disabled="showEdit"
              ...
              <van-field v-model="weight"
                         name="weight"
                         label="屠宰总重" type="number" :disabled="showEdit"
                         size="large" :rules="[{ required: true, message: '请输入入栏负责人' }]"></van-field>
              <van-field v-model="weight"
                         name="weight"
                         label="屠宰环境温湿度" type="number" :disabled="showEdit"
                         size="large" :rules="[{ required: true, message: '请输入入栏负责人' }]"></van-field>
              <van-field v-model="weight"
                         name="weight"
