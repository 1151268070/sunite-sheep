          ...
          <div class="padding">
            <van-form @submit="onSubmit">
              ...
              <van-field v-model="number"
                         name="number"
                         label="收购羊只数量" type="number" :disabled="showEdit"
                         size="large" :rules="[{ required: true, message: '请输入收购羊只数量' }]"></van-field>
              <van-field v-model="weight"
                         name="weight"
                         label="批次总重" type="number" :disabled="showEdit"
                         size="large" :rules="[{ required: true, message: '请输入批次总重' }]"></van-field>
              <van-field v-model="position"
                         name="position"
                         label="收购地点" :disabled="showEdit"
                         size="large" :rules="[{ required: true, message: '请输入收购地点' }]"></van-field>
              <van-field v-model="score"
                         name="score"
                         label="来源牧场" :disabled="showEdit"
                         size="large" :rules="[{ required: true, message: '请输入来源牧场' }]"></van-field>
              <van-field v-model="name"
                         name="name"
                         label="牧民姓名" :disabled="showEdit"
                         size="large" :rules="[{ required: true, message: '请输入牧民姓名' }]"></van-field>
              <van-field v-model="buyer"
                         name="buyer"
                         label="收购负责人姓名" size="large"
                         :rules="[{ required: true, message: '请输入收购负责人姓名' }]"></van-field>
              <van-field v-model="renNum"
                         name="renNum"
                         label="收购人数" type="number"  size="large"
                         :rules="[{ required: true, message: '请输入收购人数' }]"></van-field>
