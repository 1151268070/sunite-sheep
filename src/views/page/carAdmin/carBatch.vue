                      ...
                      <template #label>
                        <div class="widthSize">
                          <van-row class="text-size" gutter="20">
                            ...
                            <van-col span="12">
                              运输来源地：{{item.opeTime.split(' ')[0]}}
                            </van-col>
                            <van-col span="12">
                              运输目的地：{{item.opeTime.split(' ')[0]}}
                            </van-col>
                            <van-col span="12">
                              收购批次编号：{{item.opeTime.split(' ')[0]}}
                            </van-col>
                            <van-col span="12">
                              驾驶员：{{item.opeTime.split(' ')[0]}}
                            </van-col>
                            <van-col span="12">
                              运输车牌：{{item.opeTime.split(' ')[0]}}
                            </van-col>
                            <van-col span="12">
                              车辆类型：{{item.opeTime.split(' ')[0]}}
                            </van-col>
                          </van-row>
                        </div>
                      </template>
