        ...
        <div class="margin-top-fixed">
          <div class="padding">
            <van-form @submit="onSubmit">
              <van-field v-model="er_id" name="er_id" label="羊只编号"></van-field>
              <van-field v-model="er_id" name="er_id" label="分割名称"></van-field>
              <van-field v-model="weight"
                         name="weight"
                         label="分割重量" type="number" :disabled="showEdit"
              ...
              <van-field
                      ...
                      :disabled="showEdit"
                      :rules="[{ required: true, message: '选择分割批次编号' }]"
                      size>
              </van-field>
              <van-field v-model="weight"
                         name="weight"
                         label="收购批次编号" type="number" :disabled="showEdit"
                         size="large"></van-field>
